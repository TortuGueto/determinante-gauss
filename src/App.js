...
import Determinante4 from "./Paginas/Determinante4x4";
import MetodoGauss from "./Paginas/MetodoGauss";

function App() {
   return (
      <div className="dark:bg-gray-700 bg-gray-100 min-h-screen bg-white text-center transition-all">
         <Router>
            <NavBar />
            <Switch>
               ...
               <Route path="/determinante4x4" component={Determinante4} />
